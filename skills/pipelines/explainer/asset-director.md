...
6. Map cues to provider parameters:
   ...
   - Sarvam: `speaker` (lowercase, model-specific), `target_language_code` (e.g. `"hi-IN"`), `pace` in `0.5..2.0`, and `temperature` in `0.01..2.0` on `bulbul:v3`; no SSML — see the `sarvam-tts` skill
